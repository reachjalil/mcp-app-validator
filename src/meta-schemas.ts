// Official JSON Schema 2020-12 meta-schemas, https://json-schema.org/draft/2020-12/schema
// Copyright JSON Schema contributors; BSD-3-Clause. See THIRD_PARTY_NOTICES.md.
import type { Schema } from "@cfworker/json-schema";
export const metaSchemas: Schema[] = [
  {
